**Human Parts Dataset** is a dataset for object detection and identification tasks. Possible applications of the dataset could be in the surveillance industry. 
